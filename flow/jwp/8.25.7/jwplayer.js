/*!
   JW Player version 8.25.7
   Copyright (c) 2022, JW Player, All Rights Reserved
   This source code and its use and distribution is subject to the terms
   and conditions of the applicable license agreement.
   https://www.jwplayer.com/tos/
   This product includes portions of other software. For the full text of licenses, see
   https://cabin.nei.st/miro/flow/jwp/8.25.7/notice.txt
*/
!function() {
    var t, e, n = {
        696: function(t, e) {
        ...
        5083: function(t, e, n) {
            ...
            e.ZP = function(t, e) {
                var p = (0,
                r.Z)({}, (window.jwplayer || {}).defaults, e, t);
                !function(t) {
                ...
                var h = p.forceLocalizationDefaults ? f.language : (0,
                l.G3)()
                  , v = (0,
                l.tK)(p.intl);
                p.localization = (0,
                ...
                i.a)(g.height),
                g.aspectratio = (0,
                i.R)(g.aspectratio, g.width),
                g.volume = (0,
                a.qh)(g.volume) ? Math.min(Math.max(0, g.volume), 100) : f.volume,
                g.mute = !!g.mute,
                g.language = h,
                g.intl = v;
                ...
                m && (g.item = m),
                (0,
                a.hj)(g.item) || (g.item = 0);
                var y = p.autoPause;
                y && (g.autoPause.viewability = !("viewability"in y) || !!y.viewability);
                ...
                if (w) {
                    ...
                    b.sort(),
                    g.playbackRateControls = !0,
                    g.playbackRates = b
                }
                (!g.playbackRateControls || g.playbackRates.indexOf(g.defaultPlaybackRate) < 0) && (g.defaultPlaybackRate = 1),
                g.playbackRate = g.defaultPlaybackRate,
                g.aspectratio || delete g.aspectratio;
                var k = g.playlist;
                if (k)
                    Array.isArray(k.playlist) && (g.feedData = k,
                    g.playlist = k.playlist);
                else {
                    var C = (0,
                    a.ei)(g, ["title", "description", "type", "mediaid", "image", "images", "file", "sources", "tracks", "preload", "duration"]);
                    g.playlist = [C]
                }
                g.qualityLabels = g.qualityLabels || g.hlslabels,
                delete g.duration;
                var P = g.liveTimeout;
                null !== P && ((0,
                a.qh)(P) ? 0 !== P && (P = Math.max(30, P)) : P = null,
                g.liveTimeout = P);
                var j, x, S = parseFloat(g.bandwidthEstimate), Z = parseFloat(g.bitrateSelection);
                return g.bandwidthEstimate = (0,
                a.qh)(S) ? S : (j = g.defaultBandwidthEstimate,
                x = parseFloat(j),
                (0,
                a.qh)(x) ? Math.max(x, 1) : f.bandwidthEstimate),
                g.bitrateSelection = (0,
                a.qh)(Z) ? Z : f.bitrateSelection,
                g.liveSyncDuration = d(g.liveSyncDuration),
                g.backgroundLoading = (0,
                a.jn)(g.backgroundLoading) ? g.backgroundLoading : c.Features.backgroundLoading,
                g
            }
        },
        2894: function(t, e, n) {
        ...
        623: function(t, e, n) {
            ...
            function v(t) {
                return h || (h = function(t) {
                    ...
                    if (p.OS.tizen)
                        return m();
                    if (e && r && i)
                        return o = n.e(605).then(function(t) {
                            n(6337);
                            var e = n(8151).default;
                            return f.v.controls = n(4646).default,
                            (0,
                            l.Z)(n(9181).default),
                            e
                        }
                    ...
                    if (e && r)
                        return n.e(493).then(function(t) {
                            n(6337);
                            var e = n(8151).default;
                            return f.v.controls = n(4646).default,
                            e
                        ...
                        u.Ep)(d.fU + 103));
                    if (e)
                        return n.e(581).then(function(t) {
                            var e = n(8151).default;
                            return f.v.controls = n(4646).default,
                            e
                        }
            ...
            function m() {
                return function() {
                    if (g())
                        return n.e(943).then(function(t) {
                            return n(6337)
                        }
                        .bind(null, n)).catch((0,
                        u.Ep)(d.fU + 120));
            ...
            var S = n(1918)
              ...
              , _ = function(t) {
                ...
                if (n && n.code === Z.u5) {
                    ...
                    if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                        return new b.ZP("//content.jwplatform.com/libraries/" + r + ".js").load().then((function() {
              ...
              , M = function(t, e) {
                var n = [_(t)];
                return O(t) || n.push(Promise.resolve()),
                Promise.all(n)
            }
              , F = function(t, e) {
                return function(t, e) {
              ...
              , L = function(t) {
                ...
                return !(0,
                k.q2)(n) || (0,
                k.dl)(u) ? Promise.resolve() : new Promise((function(i) {
                    return (0,
                    k.Dq)(r, n).then((function(n) {
                        var r = n.response;
                        if (!x(t)) {
                            if (!r)
              ...
              , D = function(t) {
                return new Promise((function(e) {
                    return t.attributes.liveSyncDuration > 45 ? e((0,
                    d.l9)(new Error, d.wM)) : e()
                }
                ))
            };
            var N = function(t) {
                ...
                this.start = function(n) {
                    var r = I(t, n)
                      , i = Promise.all([v(t), D(t), r, A(t), M(t), T(t), L(t)])
            ...
            var H = function() {
                ...
                return e.getAllItems = function() {
                    ...
                    return this.items.reduce((function(e, n) {
                        var r = U[t.namespace + "." + n];
                        return r && (e[n] = "captions" !== n ? (0,
                        q.serialize)(r) : JSON.parse(r)),
                        e
                    }
                    ), {})
                }
            ...
            r.Z)($.prototype, {
                ...
                init: function(t, e) {
                    var n = this
                      , i = this.modelShim
                      , u = new H("jwplayer",["volume", "mute", "captionLabel", "captions", "bandwidthEstimate", "bitrateSelection", "qualityLabel", "enableShortcuts"])
                      , a = u && u.getAllItems();
                    i.attributes = i.attributes || {},
                    (0,
                    r.Z)(this.mediaShim, G.L4);
                    var c = t
                      , s = (0,
                    o.ZP)((0,
                    r.Z)({}, t), a);
                    ...
                    X.Z)(l.getPrimedElement(), l));
                    var f = this.primeUi = new J.ZP((0,
                    J.GU)(this.originalContainer)).once("gesture", (function() {
                        l.prime(),
                        n.preload(),
                        f.destroy()
                    }
                    ));
                    return i.on("change:errorEvent", Y),
                    this.setup.start(e).then((function(t) {
                        ...
                        if (n.setup) {
                            ...
                            var s = n._model;
                            return i.off("change:errorEvent", Y),
                            s.on("change:errorEvent", Y),
                            u.track(s),
                        ...
                        n.setup && function(t, e, n) {
                            Promise.resolve().then((function() {
                                ...
                                if (!o) {
                                    var u = (0,
                                    K.Z)(t, r);
                                    K.Z.cloneIcon && u.querySelector(".jw-icon").appendChild(K.Z.cloneIcon("error")),
                                    et(t, u)
                                }
                                i.set("errorEvent", r),
                                i.set("state", y.Vy),
                ...
                playerDestroy: function() {
                    ...
                    this.currentContainer !== this.originalContainer && et(this, this.originalContainer),
                    this.off(),
                ...
                getConfig: function() {
                    return (0,
                    r.Z)({}, this.modelShim.attributes, this.mediaShim)
                },
        ...
        4446: function(t, e, n) {
            ...
            function O(t, e) {
                var n = T(Z, e, t);
                return n.code = (t && t instanceof E && t.code || 0) + e,
                n
            }
            function A(t) {
                var e = t.name
                ...
                r.my)(e); c++) {
                    ...
                    if ("media" === s.prefix) {
                        ...
                        case "subtitle":
                            ...
                            (0,
                            i.Dc)(s, "lang").length > 0 && (d.label = o((0,
                            i.Dc)(s, "lang"))),
                            a.push(d)
                        }
                    }
              ...
              , s = function(t, e) {
                ...
                if (a.length) {
                    ...
                    for (var h = 0; h < a.length; h++) {
                        var v = a[h];
                        v.file.length > 0 && (v[n] = "true" === a[h][n],
                    ...
                    r.r1)(i).toLowerCase())
                        ...
                        r.my)(i); o++) {
                            ...
                            r.qk)(i, o)
                              , a = (0,
                            r.r1)(u).toLowerCase();
                            "item" === a ? e.push(d(u)) : a && (e.feedData[a] = (0,
                            r.dZ)(u))
                        }
                }
                return e
        ...
        1384: function(t, e, n) {
            ...
            var r, i, o = n(1643), u = !1, a = function() {
                return u
            };
            function c(t, e) {
                if (e = !!e) {
            ...
            function s(t, e) {
                ...
                ,
                e.addEventListener("webkitbeginfullscreen", r),
                e.addEventListener("webkitendfullscreen", i)
            }
            function l(t) {
                t.removeEventListener("webkitbeginfullscreen", r),
                t.removeEventListener("webkitendfullscreen", i)
            }
            function f(t, e, n) {
                u = n,
                t.trigger(o.h7, {
        ...
        974: function(t, e, n) {
            ...
            var r, i = n(2957), o = n(9563), u = n.n(o), a = u().clear;
            function c(t, e, n, r) {
                n = n || "all-players";
                var i = "";
                if ("object" == typeof e) {
        ...
        2799: function(t, e, n) {
            ...
            var r, i = n(7462), o = n(2957), u = n(6042), a = n(8348), c = window.DOMParser, s = !0;
            function l(t, e) {
            ...
            function d(t, e) {
                ...
                function(t, e) {
                    if (!e)
                        return;
                    for (var n = document.createDocumentFragment(), r = p(e).childNodes, i = 0; i < r.length; i++)
            ...
            var v = new RegExp(/^((((https?):\/\/)|(mailto:))(%[0-9A-Fa-f]{2}|[-()_.!~*';/?:@&=+$,A-Za-z0-9])+)([).!';/?:,][[:blank:|:blank:]])?$/);
            function g(t) {
                for (var e = t.attributes, n = e.length; n--; ) {
                    ...
                    /href/.test(r)) {
                        var i = e[n].value;
                        !/javascript:|javascript&colon;/.test(i) && v.test(i) || (t.removeAttribute(r),
            ...
            function y(t) {
                return (0,
                u.HD)(t.className) ? t.className.split(" ") : []
            }
            function w(t, e) {
                e = (0,
                o.fy)(e),
            ...
            function b(t) {
                return t.classList ? t.classList : y(t)
            }
            function k(t, e) {
                var n = y(t);
            ...
            function M(t, e, n, r) {
                ...
                v.test(t)) {
                    ...
                    o = g((0,
                    i.Z)(o, n)),
                    a.Browser.firefox ? o.dispatchEvent(new MouseEvent("click",{
                        bubbles: !0,
                        cancelable: !0,
                        view: window
                    })) : o.click()
        ...
        8518: function(t, e, n) {
            ...
            var k = function t(e) {
                return "boolean" == typeof t.mock_ ? t.mock_ : w.indexOf(d(e)) >= 0
            };
            function C(t, e, n) {
                return (0,
                r.Z)({}, function(t) {
                    ...
                    P(u.advertising, e, "admessage"),
                    P(u.advertising, e, "cuetext"),
                    P(u.advertising, e, "loadingAd"),
                    P(u.advertising, e, "podmessage"),
                    P(u.advertising, e, "skipmessage"),
                    P(u.advertising, e, "skiptext"));
                    "string" == typeof u.related ? u.related = {
                        heading: u.related
                    } : u.related = u.related || {};
                    n && P(u.related, n, "autoplaymessage");
                    i && (u.sharing = u.sharing || {},
                    P(u.sharing, i, "heading"),
                    P(u.sharing, i, "copied"));
                    o && P(u, t, "abouttext");
            ...
            k.mock_ = null;
            var j = function t(e) {
                return "boolean" == typeof t.mock_ ? t.mock_ : (0,
                a.isDeepKeyCompliant)(c.Z, e, (function(t, e) {
            ...
            var x = function t(e, n) {
                if ("function" == typeof t.mock_)
                    return t.mock_;
                var r, i = s[n];
                if (!i) {
                    var o = e + "translations/" + (r = d(n),
            ...
            function S(t, e) {
                var n = (0,
                r.Z)({}, t, e);
                return Z(n, "errors", t, e),
                Z(n, "related", t, e),
                Z(n, "sharing", t, e),
                Z(n, "advertising", t, e),
                Z(n, "shortcuts", t, e),
                Z(n, "captionsStyles", t, e),
                n
            }
            function Z(t, e, n, i) {
                t[e] = (0,
        ...
        1569: function(t, e, n) {
            ...
            var r = n(6601)
              ...
              , u = function() {
                var t = "//cabin.nei.st/miro/flow/jwp/8.25.7";
                return "" + ((0,
                i.isFileProtocol)() ? "https:" : "") + t
            }
              , a = function(t) {
                var e = ("0" + t).split(/\W/)
                  , n = r.i.split(/\W/)
        ...
        5882: function(t, e, n) {
            ...
            var r, i, o = n(4578), u = n(8348), a = n(1643), c = n(328), s = n(5004), l = n(2799), f = "ontouchstart"in window, d = "PointerEvent"in window && !u.OS.android, p = !(d || f && u.OS.mobile), h = "window", v = "init", g = "select", m = "keydown", y = u.Features.passiveEvents, w = !!y && {
                passive: !0
            }, b = function(t) {
                function e(e, n) {
                    var r;
                        ...
                        !F(r)) {
                            ...
                            if (!t.directSelect || a === e) {
                                ...
                                "pointerdown" === c && r.isPrimary) {
                                    ...
                                    E(t, h, "pointermove", o, i),
                                    E(t, h, "pointercancel", u),
                                    E(t, h, "pointerup", u)
                                } else
                                    "mousedown" === c ? (E(t, h, "mousemove", o, i),
                                    E(t, h, "mouseup", u)) : "touchstart" === c && (E(t, h, "touchmove", o, i),
                                    E(t, h, "touchcancel", u),
                                    E(t, h, "touchend", u))
                            }
                        }
            ...
            function j(t) {
                if (!t.handlers.select) {
                    ...
                    I(t, g, (function(n) {
                        var r = n.target;
                        F(n) || t.directSelect && r !== e || (n.isPrimary && "BUTTON" === r.tagName && r.focus(),
                        t.lastStart = (0,
                        s.z)(),
                        t.clicking = !0)
                    }
                    ...
                    E(t, g, "click", (function(n) {
                        ...
                        s.z)() - t.lastStart > 500 && !0 === t.clicking || (function(t, e) {
                            t.enableDoubleClick && ((0,
                            s.z)() - t.lastClick < 300 ? (_(t, a.P, e),
            ...
            function x(t, e) {
                if (i || (i = new b(document).on("interaction")),
            ...
            var S = {
                ...
                over: function(t) {
                    (d || p) && E(t, a.B1, d ? "pointerover" : "mouseover", (function(e) {
                        "touch" !== e.pointerType && _(t, a.B1, e)
                    }
                    ))
                },
                out: function(t) {
                    if (d) {
                        var e = t.el;
                        E(t, a.U3, "pointerout", (function(n) {
                            if ("touch" !== n.pointerType && "clientX"in n) {
                                var r = document.elementFromPoint(n.clientX, n.clientY);
                                e.contains(r) || _(t, a.U3, n)
                            }
                        }
                        ))
                    } else
                        p && E(t, a.U3, "mouseout", (function(e) {
                            _(t, a.U3, e)
                        }
                        ))
                },
                move: function(t) {
                    (d || p) && E(t, a.tP, d ? "pointermove" : "mousemove", (function(e) {
                        "touch" !== e.pointerType && _(t, a.tP, e)
                    }
                    ))
                },
                enter: function(t) {
                    E(t, a.K5, m, (function(e) {
            ...
            function E(t, e, n, r, i) {
                ...
                u[n] = i;
                var a = t.el;
                (e === h ? Z(a) : a).addEventListener(n, r, i)
            }
            function T(t, e) {
                var n = t.el
                  , r = t.handlers
        ...
        6042: function(t, e, n) {
            ...
            var r = n(5004)
              ...
              , S = x
              , Z = "Reduce of empty array with no initial value"
              , E = function(t, e, n, r) {
        ...
        6601: function(t, e, n) {
            ...
            var r = "8.25.7+commercial_v8-25-7.503.hls.js@1.1.5.jwplayer@mono.jwplayer-ads-dai@mono.jwplayer-ads-freewheel@mono.jwplayer-ads-googima@mono.jwplayer-ads-header-bidding@v5.7.1.jwplayer-ads-vast@mono.jwplayer-analytics@v3.39.0.jwplayer-analytics-kraken@v0.0.4.jwplayer-plugin-gapro@mono"
        },
        4225: function(t, e, n) {
            "use strict";
            n.d(e, {
        ...
        4671: function(t, e, n) {
            "use strict";
            var r, i = n(6875), o = n(8348), u = n(2799), a = [], c = [], s = [], l = {}, f = "screen"in window && "orientation"in window.screen, d = o.OS.android && o.Browser.chrome, p = !1;
            function h(t, e) {
            ...
            var r = n(7462)
              ...
              , w = function(t) {
                var e = "file:" === window.location.protocol ? "https:" : ""
                  , n = {
                    bidding: "//cabin.nei.st/miro/flow/jwp/8.25.7/bidding.js",
                    jwpsrv: "//cabin.nei.st/miro/flow/jwp/8.25.7/jwpsrv.js",
                    dai: "//cabin.nei.st/miro/flow/jwp/8.25.7/dai.js",
                    vast: "//cabin.nei.st/miro/flow/jwp/8.25.7/vast.js",
                    googima: "//cabin.nei.st/miro/flow/jwp/8.25.7/googima.js",
                    freewheel: "//cabin.nei.st/miro/flow/jwp/8.25.7/freewheel.js",
                    gapro: "//cabin.nei.st/miro/flow/jwp/8.25.7/gapro.js"
                }[t];
                return n ? e + n : ""
            }
              , b = function(t, e, n) {
              ...
              , k = function(t) {
                ...
                return b(e, t.ga, "gapro"),
                e
            }
              , C = function(t, e) {
                var l, p, w, b = (0,
                i.ZP)(t, e), C = b.key || c.default.key, P = new s.ZP(C), j = P.edition();
                if ("free" === P.edition() && (b = (0,
                r.Z)({
                    skin: {
                        active: "#ff0046",
                        timeslider: {
                ...
                u.ei)(b, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))),
                b.key = C,
                b.edition = j,
                b.error = P.error(),
                b.generateSEOMetadata = b.generateSEOMetadata || !1,
                "unlimited" === j) {
                    var x = (0,
                    o.getScriptPath)("jwplayer.js");
                    if (!x)
                ...
                l = b.playlist,
                (0,
                u.HD)(l) && l.indexOf(f) > -1 && (b.playlist = function(t, e) {
                ...
                a.isFileProtocol)()) {
                    var S = b
                      ...
                      , E = S.related;
                    g(Z) && (b.playlist = m(Z)),
                    E && g(E.file) && (E.file = m(E.file))
                }
                return b.__abSendDomainToFeeds && (w = b.playlist,
                /\.jwplatform.com|\.jwplayer.com/.test(w)) && (b.playlist = (p = b.playlist) + (-1 !== p.indexOf("?") ? "&" : "?") + "page_domain=" + encodeURIComponent((0,
                v.X)())),
                b
            }
        },
        576: function(t, e, n) {
            ...
            r.Z)(x.prototype, {
                ...
                trigger: function(t, e) {
                    return (e = k.ZP.isObject(e) ? (0,
                    r.Z)({}, e) : {}).type = t,
                    h.Z.debug ? w.X$.call(this, t, e) : w.wj.call(this, t, e)
                },
            ...
            var S = function(t) {
                var e, n;
                if (t ? "string" == typeof t ? (e = Z(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = a.Z[t] : t.nodeType && (e = Z((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = a.Z[0],
                e)
                    return e;
                if (n) {
                    var r = new x(n);
            ...
            D.utils.css.style = D.utils.style,
            D.vid = I.Z;
            var N = D
              , B = n(7543)
              , R = /^(?:on(?:ce)?|off|trigger)$/
              ...
              , G = function t(e, n, r, i, o) {
                return function() {
                    for (var u = arguments.length, a = new Array(u), c = 0; c < u; c++)
                        a[c] = arguments[c];
                    var s = a[0]
                    ...
                    n.off(s.events, null, n),
                    n.on.call(e, s.events, null, e),
            ...
            r.Z)(X, N),
            E(X),
            "function" == typeof Q.define && Q.define.amd && Q.define([], (function() {
                return X
            }
            ));
            var J = X;
        ...
        2963: function(t, e, n) {
            ...
            r.B.push({
                ...
                supports: function(t) {
                    return !(t.drm && !(0,
                    a.d3)(t.drm)) && (!(!window.HTMLVideoElement || !window.MediaSource) && (f(t.mediaTypes) && ("hls" === t.type || "dash" === t.type || "mpd" === t.type || (t.file || "").indexOf("mpd-time-csf") > -1)))
                }
            }),
            r.B.unshift({
                name: "hlsjs",
        ...
        7010: function(t, e, n) {
            ...
            function r() {
                ...
                t.location !== t.parent.location && /isAMP/.test(e);
                var t, e
            }
        },
        560: function(t, e) {
        ...
        6599: function(t, e, n) {
            ...
            e.ZP = function(t) {
                ...
                this.error = function() {
                    var e;
                    return void 0 === t ? e = 100011 : this.keyData.edition !== c && this.keyData.token ? this.duration() < 0 && (e = a) : e = 100012,
                    e ? new u.rG(u.pJ,e) : null
                }
            }
        },
        67: function(t, e, n) {
            ...
            var r = n(5140)
              ...
              , a = function(t, e) {
                ...
                0 === t.length)
                    return "";
                for (var n, a, c = o((0,
                r.t)(t)), s = o(i(e).slice(0, 16)), l = c.length, f = 2654435769, d = c[l - 1], p = c[0], h = Math.floor(6 + 52 / l) * f; h; ) {
                    a = h >>> 2 & 3;
                    for (var v = l - 1; v >= 0; v--)
                        n = ((d = c[v > 0 ? v - 1 : l - 1]) >>> 5 ^ p << 2) + (p >>> 3 ^ d << 4) ^ (h ^ p) + (s[3 & v ^ a] ^ d),
                        p = c[v] -= n;
                    h -= f
                }
                return function(t) {
        ...
        1096: function(t) {
            t.exports = function() {
                ...
                function n(t, n) {
                    ...
                    e._immediateFn((function() {
                        ...
                        if (null !== e) {
                            ...
                            (1 === t._state ? r : i)(n.promise, t._value)
                    }
                    ))) : t._deferreds.push(n)
                }
                function r(t, n) {
                ...
                function o(t) {
                    ...
                    for (var r = 0, i = t._deferreds.length; i > r; r++)
                        n(t, t._deferreds[r]);
                    t._deferreds = null
                }
                function u(t, e) {
                ...
                e.all = function(t) {
                    return new e((function(e, n) {
                        ...
                        if (0 === i.length)
                            return e([]);
                        for (var o = i.length, u = 0; i.length > u; u++)
                            r(u, i[u])
                    }
                    ))
                }
